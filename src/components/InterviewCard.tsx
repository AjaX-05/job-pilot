...
const InterviewCard: React.FC<InterviewCardProps> = ({ onStartInterview, loading, error }) => {
  ...
  return (
    <div className="grid md:grid-cols-5 gap-6 bg-white rounded-xl shadow-md overflow-hidden transition-all">
      <div className="md:col-span-3 overflow-hidden">
        <img 
          src="https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" 
          alt="Interview scene with people shaking hands" 
      ...
      <div className="md:col-span-2 p-6 md:p-8 flex flex-col">
        ...
        <p className="text-gray-600 text-sm mb-6">
          Kickstart your career with AI-driven mock interviews. Upload your resume and get personalized
        ...
        <button
          ...
          className={`mt-auto w-full px-4 py-3 bg-blue-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center
            ${loading || !resumeFile ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-600'}`}
        >
          {loading ? (
